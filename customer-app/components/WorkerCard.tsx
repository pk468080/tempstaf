...
const styles = StyleSheet.create({
  card: { width: '100%', backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.border, borderRadius: 20, padding: 17, marginBottom: 14 },
  top: { flexDirection: 'row', alignItems: 'flex-start' },
  avatar: { width: 62, height: 62, borderRadius: 31, backgroundColor: COLORS.navy, alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  avatarText: { color: COLORS.white, fontSize: 25, fontWeight: '800' },
  info: { flex: 1 },
  nameRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' },
  name: { color: COLORS.navy, fontSize: 16, fontWeight: '800' },
  badge: { backgroundColor: '#EAF8EF', borderRadius: 8, paddingHorizontal: 7, paddingVertical: 4, marginLeft: 7 },
  ...
  divider: { height: 1, backgroundColor: '#EEF1F4', marginVertical: 15 },
  bottom: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  available: { color: COLORS.green, fontSize: 13, fontWeight: '800' },
  small: { color: COLORS.gray, fontSize: 11, marginTop: 3 },
  select: { height: 42, paddingHorizontal: 17, borderRadius: 21, backgroundColor: COLORS.orange, alignItems: 'center', justifyContent: 'center' },
